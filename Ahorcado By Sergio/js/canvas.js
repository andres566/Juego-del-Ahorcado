...
listaPalabras.push("JUEGO");
listaPalabras.push("TRAMPA");
listaPalabras.push("CHILE");
listaPalabras.push("PARTIDO");
listaPalabras.push("OSO");
listaPalabras.push("COMPLEJO");
listaPalabras.push("FULLSTACK");
listaPalabras.push("GITHUB");
listaPalabras.push("SQL");
listaPalabras.push("PYTHON");
listaPalabras.push("VISUAL");
listaPalabras.push("PANTALON");
listaPalabras.push("BOLSO");
listaPalabras.push("TECLADO");
listaPalabras.push("TELEFONO");
listaPalabras.push("CUADERNO");
listaPalabras.push("TELEVISOR");
listaPalabras.push("MESA");
listaPalabras.push("VASO");
...
function gameOver(errores) {
    ...
    if (errores < 6) {
        pincel.fillText("¡Felicidades! Ganaste La palabra es: ", 110, 280);
    } else {
